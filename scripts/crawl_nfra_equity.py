...
用法:
    python scripts/crawl_nfra_equity.py --start-page 1 --end-page 5
    python scripts/crawl_nfra_equity.py --item-id 4291 --start-page 1 --end-page 3
"""
...
def main() -> int:
    ...
    setup_logging()
    logger.info(
        "启动 nfra 股权变更/开业股东采集: itemId={} start_page={} end_page={} concurrency={}",
